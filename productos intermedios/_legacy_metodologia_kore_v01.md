  ...
  - [LIBRO I: LA CARGA DEL MODELO — INSTALACIÓN DEL SISTEMA OPERATIVO MENTAL](#libro-i-la-carga-del-modelo--instalación-del-sistema-operativo-mental)
    ...
    - [CAPÍTULO 2: EL VOCABULARIO CONTROLADO](#capítulo-2-el-vocabulario-controlado)
      ...
      - [2.3. Léxico de Conceptos Clave: Los Nombres de la Realidad Operacional](#23-léxico-de-conceptos-clave-los-nombres-de-la-realidad-operacional)
        ...
        - [2.3.3. Conceptos Operacionales (Nivel O)](#233-conceptos-operacionales-nivel-o)
  - [LIBRO II: LA EJECUCIÓN DE LOS PROTOCOLOS — LOS RITMOS DE CREACIÓN DE VALOR](#libro-ii-la-ejecución-de-los-protocolos--los-ritmos-de-creación-de-valor)
    ...
    - [CAPÍTULO 4: EL CICLO TRIMESTRAL — NAVEGACIÓN TÁCTICA (Σ-T / Δ-T / Δ-E)](#capítulo-4-el-ciclo-trimestral--navegación-táctica-σ-t--δ-t--δ-e)
      ...
      - [4.2. Fase 2: Planificación de la Evolución (Protocolo Δ-T)](#42-fase-2-planificación-de-la-evolución-protocolo-δ-t)
        ...
        - [4.2.2. Protocolo de Desglose de Valor: Taller de `Mapeo de Historias`](#422-protocolo-de-desglose-de-valor-taller-de-mapeo-de-historias)
  ...
  - [LIBRO III: LA ORQUESTACIÓN AVANZADA — PROTOCOLOS PARA LA MAESTRÍA](#libro-iii-la-orquestación-avanzada--protocolos-para-la-maestría)
    - [CAPÍTULO 6: PROTOCOLOS DE NAVEGACIÓN AVANZADA](#capítulo-6-protocolos-de-navegación-avanzada)
      - [6.1. Protocolo de Diagnóstico Rápido: El "Scanner" de Coherencia](#61-protocolo-de-diagnóstico-rápido-el-scanner-de-coherencia)
        - [6.1.1. Preparación: Selección de la EV y Recopilación de Artefactos Existentes](#611-preparación-selección-de-la-ev-y-recopilación-de-artefactos-existentes)
    ...
    - [CAPÍTULO 8: GOBIERNO SEMÁNTICO Y ESCALADO](#capítulo-8-gobierno-semántico-y-escalado)
      ...
      - [8.3. El `Overlay Regulatorio` como Conjunto de Axiomas Globales](#83-el-overlay-regulatorio-como-conjunto-de-axiomas-globales)
        - [8.3.1. Método para traducir marcos regulatorios complejos en un conjunto de axiomas verificables](#831-método-para-traducir-marcos-regulatorios-complejos-en-un-conjunto-de-axiomas-verificables)
...
* Tablero de Flujo (Xanpan) (Δ-O): Es la herramienta visual para gestionar el trabajo diario del equipo. Muestra el flujo de tareas desde la idea hasta la entrega, haciendo visibles los cuellos de botella. Se basa en limitar el Trabajo en Progreso (WIP) para maximizar la velocidad de entrega y la calidad.
...
* **Flujo:** El movimiento del trabajo a través del sistema del equipo. El objetivo principal de la gestión operacional es optimizar el flujo, asegurando que el valor se entregue de la manera más rápida y predecible posible, en lugar de simplemente mantener a las personas "ocupadas".
...
###### 3.1.1.1. Preparación: Selección de Participantes y Recopilación de Insumos
...
###### 3.1.2.3. Visualización de Brechas Estratégicas
...
* *Objetivo 1: "Convertirnos en un referente de transparencia y acceso a la información".* (Derivado de un mandato de gobierno abierto).
...
Este inventario revela inmediatamente el estado actual de la inversión: qué capacidades están recibiendo más recursos y cuáles podrían estar desatendidas.
...
###### 4.1.1.3. Validación de Coherencia del Canvas
...
###### 4.2.1.3. Heurísticas para OKRs de Calidad: Foco en *outcomes*, no *outputs*; aspiracionales vs. utilitarios
...
* **🚀 Continuar/Pivotar:** La decisión por defecto. La inversión se mantiene. Se aprueban los nuevos OKRs o se pide un ajuste (pivote) basado en los aprendizajes.
...
###### 5.1.1.2. Criterios de Aceptación para un Contrato
...
###### 5.2.1.2. Calibración Inicial de los Límites WIP
...
Estas métricas no se usan para evaluar a las personas, sino para entender y mejorar la salud del sistema de trabajo.
...
##### 6.1.3. Síntesis: Creación del Mapa de Disonancia y Formulación de Hipótesis de Intervención
...
##### 6.2.3. Trazabilidad del Cambio: Siguiendo una idea desde un ADR (Δ-O) hasta un cambio en el Mapa de Capacidades (Σ-E)
...
*No empieces por la solución. Empieza por el "porqué" y el "quién".*
...
##### 7.2.1. Fase de Arqueología: Modelado del sistema legacy como una EV "As-Is" (Protocolo Σ-T)
...
Este protocolo transforma un proceso fragmentado y conflictivo en un **ecosistema de servicios colaborativos**, disolviendo las barreras organizacionales a través de interfaces claras, compromisos explícitos y objetivos compartidos.
...
Este modelo equilibra la autonomía del equipo (propiedad local) con la necesidad de visibilidad y coherencia a nivel organizacional (descubrimiento centralizado), permitiendo a cualquier arquitecto encontrar y aprender de los diseños de otros equipos sin crear un cuello de botella burocrático.
...
##### 8.3.1. Método para traducir marcos regulatorios complejos en un conjunto de axiomas verificables
...
* **Celebrar el Aprendizaje, no solo el Éxito:** Cuando una hipótesis de valor (un OKR) se invalida, el resultado no es un "fracaso", es un "aprendizaje valioso". Los líderes deben celebrar públicamente estos aprendizajes, demostrando que el objetivo es aprender rápido, no tener siempre la razón.
* **Modelar la Vulnerabilidad:** Los líderes deben admitir sus propios errores y las cosas que no saben. Esto crea un permiso para que otros hagan lo mismo.
* **Enmarcar el Trabajo como un Problema de Aprendizaje:** El lenguaje del liderazgo debe cambiar de "ejecutar este plan" a "probar esta hipótesis". Esto enmarca el trabajo no como una marcha hacia un destino conocido, sino como una expedición de descubrimiento.

##### 8.4.2. Gestión del "Business As Usual" (BAU) y el "Objetivo Cero"

Un error común es asumir que los equipos pueden dedicar el 100% de su capacidad a los nuevos OKRs. La realidad es que deben dedicar tiempo a mantener los sistemas existentes, corregir errores y dar soporte (el "Business As Usual" o BAU). Si este trabajo no se visibiliza y gestiona, consume la capacidad de innovación y genera frustración.

El protocolo para manejar esto es el **"Objetivo Cero"**:

* **Visibilizar el BAU:** Se crea un "OKR Cero" o "OKR de Flujo" permanente para cada equipo, cuyo propósito es "Mantener la salud y fiabilidad de nuestros servicios existentes".
* **Asignar Capacidad Explícita:** El equipo, en conversación con el Dueño de Producto, asigna un porcentaje explícito de su capacidad trimestral a este Objetivo Cero (ej. "Dedicaremos el 25% de nuestra capacidad a tareas de mantenimiento y soporte").
* **Proteger la Capacidad de Innovación:** La capacidad restante (el 75% en el ejemplo) es la que está disponible para los OKRs de transformación. Esto permite una planificación más realista y protege al equipo del agotamiento, haciendo explícito el costo de "mantener las luces encendidas".

##### 8.4.3. Desvinculación de OKRs de la Compensación Financiera

Este es un principio no negociable para que el sistema de OKRs funcione. Si el logro de los KRs se vincula directamente a bonos o evaluaciones de desempeño, se destruye su propósito fundamental y se generan comportamientos disfuncionales:

* **Metas Tímidas (Sandbagging):** Los equipos establecerán KRs seguros y fáciles de alcanzar para garantizar su bono, eliminando cualquier ambición de aspirar a logros extraordinarios ("moonshots").
* **Foco en el Número, no en el Valor:** Los equipos harán lo que sea para mover la métrica, incluso si eso significa tomar atajos o generar un valor falso para el cliente.
* **Competencia Destructiva:** Se desincentiva la colaboración entre equipos si puede poner en riesgo el logro de los propios OKRs.

Los OKRs son una herramienta para el **alineamiento, el foco y el aprendizaje**, no para la evaluación del desempeño individual. La evaluación del desempeño debe ser un proceso separado y más holístico, que considere las contribuciones de un individuo al equipo, su colaboración, su impacto y cómo ha demostrado aprendizaje y crecimiento, independientemente de si sus OKRs se alcanzaron al 70% o al 100%.
...
| | C.2.1 | Planificación de Inspecciones | 2 (En Desarrollo) | 3 (Alta) | Planificación basada en datos históricos, no en riesgo. |
| | C.2.2 | Ejecución de Inspecciones | 3 (Madura) | 4 (Crítica) | |
| | C.2.3 | Gestión de Hallazgos | 2 (En Desarrollo) | 4 (Crítica) | Proceso de seguimiento de hallazgos es manual. |
...
| **S.2** | **Gestión Financiera** | | **3 (Madura)** | **3 (Alta)** | |
| **S.3** | **Gestión Tecnológica** | | **2 (En Desarrollo)** | **4 (Crítica)** | Alta deuda técnica en plataformas centrales. |
...
| KR 3: [Descripción del KR] | [Valor inicial] | [Valor objetivo] | [Valor al final] | [XX]% | [¿Qué impedimento encontramos?] |
...
| **Tasa de Errores (SLO)** | 🟢 (0.05%) | Mejorando | |
...
| • **Propósito Esencial:** (Verbo + Qué + Para Qué)<br>• **Alineamiento Estratégico:** (OKR Anual al que contribuye)<br>• **Problema/Oportunidad:** (Dolor del ciudadano o fricción interna que resuelve)<br>• **Valor Público:** (Cómo mejora la vida de las personas o la eficiencia del Estado) | • **Clientes/Usuarios:** (Beneficiarios finales)<br>• **Participantes Internos:** (Funcionarios que operan el sistema)<br>• **Agentes Digitales (IA):** (Propósito HCAI y función cognitiva)<br>• **Experiencia (Journey):** (Frustraciones y motivaciones del actor principal) | • **Evento de Inicio:** (Detonante del flujo)<br>• **Etapas Macro:** (Flujo simple de 3-5 pasos)<br>• **Resultado Final:** (Producto, servicio o decisión generada)<br>• **Intervenciones Humanas Clave (HITL):** (Puntos de juicio o validación humana) |
...
| • **Capacidades de Negocio:** (Habilidades que realiza, ej. "Gestión de Expedientes")<br>• **Servicios Expuestos (APIs):** (Servicios reutilizables que ofrece, ej. "Consultar Estado de Trámite")<br>• **Consumidores:** (Otras EVs que consumen estos servicios) | • **Datos Consumidos:** (Productos de Datos que necesita, ej. Registro Social de Hogares)<br>• **Datos Producidos:** (Productos de Datos que genera, ej. Expediente Digital)<br>• **Clasificación:** (¿Dato personal, sensible, crítico?)<br>• **Fuente de Verdad:** (Dónde reside la fuente autoritativa) | • **Aplicaciones y Componentes:** (Portal Web, API Gateway, etc.)<br>• **Plataformas Transversales:** (Plataforma de Identidad, Bus de Eventos, etc.)<br>• **Stack Tecnológico:** (Lenguajes, frameworks, BBDD) |
...
| • **Dependencias Internas:** (Otras EVs de las que dependemos)<br>• **Dependencias Externas:** (Proveedores, otros servicios públicos)<br>• **Riesgos de Dependencia:** (Principal riesgo si una dependencia falla) | • **Dueño de Producto/Servicio:** (Persona con autoridad final)<br>• **Mandato Regulatorio:** (Leyes, decretos, normativas)<br>• **Nivel de Riesgo:** (Bajo, Medio, Alto)<br>• **Políticas Clave Aplicables:** (Seguridad, privacidad, etc.) | • **Resultados Clave (KRs):** (2-3 métricas de *outcome* que la EV debe mover)<br>• **Objetivos de Nivel de Servicio (SLOs):** (2-3 compromisos de fiabilidad y calidad, ej. Disponibilidad 99.9%)<br>• **Métricas de Experiencia (UX):** (CSAT, Tasa de Éxito de Tarea) |
```
...
3. **Las Rebanadas (Líneas Horizontales):**
    ...
    * **Rebanada 1 (Esqueleto Andante / MVP):** Es la línea más alta. Contiene el conjunto mínimo de historias de cada actividad para que un usuario pueda completar el viaje de punta a punta. Este es el foco del primer ciclo de desarrollo.
    * **Rebanada 2, 3, ...:** Son los siguientes incrementos de valor, que añaden más funcionalidades o refinan las existentes.

**Ejemplo Visual Simplificado:**

| (Actividad) | **Buscar Info** | **Simular Beneficio** | **Completar Formulario** |
| :--- | :--- | :--- | :--- |
| **(Historias)** | `Ver lista de subsidios` | `Simular con 3 preguntas` | `Rellenar datos personales` |
| | `Buscar por palabra clave` | `Ver detalle del cálculo` | `Guardar borrador` |
| **---** | **--- Rebanada 1 (MVP) ---** | **---** | **---** |
| | `Filtrar por categoría` | `Enviar simulación por email`| `Validar RUT en línea` |
| | `Ver subsidios relacionados`| | `Cargar datos desde perfil` |

### A.3. Plantillas de Nivel Operacional (Σ-O / Δ-O)

#### **Plantilla A.3.1: Reglas del Tablero de Flujo (Xanpan) (Δ-O)**

**Instrucciones:** Esta no es una plantilla de un tablero en sí, sino de las "reglas del juego" que el equipo define para su tablero. Estas políticas deben estar visibles para todo el equipo, ya sea en la propia pizarra o en una página de la wiki.
...
*   **Regla:** Un miembro del equipo no puede iniciar un nuevo ítem si la columna de destino está en su límite de WIP. En su lugar, debe ayudar a "desatascar" un ítem de una columna posterior (swarming).
...
- [ ] Todas las pruebas automatizadas (unitarias, integración) pasan en el pipeline de CI.
- [ ] La revisión de código (code review) ha sido aprobada por al menos un par.
- [ ] La documentación relevante (si aplica) ha sido actualizada.
- [ ] La funcionalidad ha sido desplegada en el entorno de producción.

### 4. Políticas Adicionales

*   **Carril de Urgencia (Expedite Lane):** Se reserva un carril en la parte superior del tablero para incidentes de producción o bloqueadores críticos. Este carril ignora los límites de WIP.
*   **Bloqueos:** Un ítem bloqueado se marca con un post-it rojo o una etiqueta. La resolución de bloqueos tiene la máxima prioridad para todo el equipo.
*   **Métricas a Seguir:** Semanalmente revisamos: Lead Time promedio, Cycle Time por etapa y Throughput.
```

#### **Plantilla A.3.2: Bitácora de Decisiones (ADR) (Δ-O)**

**Instrucciones:** Use esta plantilla para registrar una decisión arquitectónica significativa. Cree un nuevo archivo Markdown para cada ADR (ej. `001-patron-de-autenticacion.md`) y guárdelo en un directorio `/adrs` dentro del repositorio del equipo. Un ADR, una vez publicado, es inmutable.
...
*¿Cuál es el problema que estamos tratando de resolver? ¿Cuáles son las fuerzas en juego (requerimientos, restricciones)? ¿Qué alternativas se consideraron?*

**Ejemplo:** "El sistema actual de autenticación basado en sesiones locales no escala y dificulta la integración con nuevos servicios móviles. Evaluamos tres alternativas:
1.  Mantener el sistema actual y añadir parches.
2.  Implementar un servidor OAuth 2.0 desde cero.
3.  Integrar un servicio de identidad federada basado en OpenID Connect (OIDC)."
...
*   **Desacoplamiento:** La autenticación se convierte en un servicio centralizado, desacoplando esta preocupación de cada EV.
*   **Seguridad Mejorada:** Delegamos la gestión de credenciales a un sistema especializado y auditado.
*   **Experiencia de Usuario (SSO):** Habilita el Single Sign-On (SSO) a través de todas nuestras aplicaciones.

### Negativas / Compromisos

*   **Dependencia Externa:** Introducimos una dependencia crítica en el proveedor de identidad. Su caída impactará a toda la plataforma.
*   **Curva de Aprendizaje:** El equipo necesita capacitarse en los flujos y complejidades de OIDC.
*   **Costo de Migración:** Requerirá un esfuerzo coordinado para migrar todas las aplicaciones existentes al nuevo sistema.
```

### A.4. Checklists de Contratos Conversacionales

**Instrucciones:** Estas no son plantillas de documentos a rellenar, sino **agendas para una conversación estratégica**. Utilice el checklist correspondiente para guiar una reunión entre las partes involucradas (ej. el equipo productor y el equipo consumidor de un servicio). El objetivo no es producir un artefacto, sino alcanzar un **entendimiento mutuo y un acuerdo explícito**. Documente las respuestas y acuerdos de forma simple (una página en la wiki, un email de resumen) como evidencia de la conversación.
...
* **Cuándo usarlo:** Cada vez que una EV expone un conjunto de datos significativo para ser utilizado por otros.
...
| **2. Estructura y Acceso** | • ¿Qué campos de información contiene (esquema)? ¿Cuáles son obligatorios?<br>• ¿Cómo se accederá a los datos (ej. API, vista en BBDD, archivo en Data Lake)? |
...
### A.5. Guía de Facilitación de Rituales

**Instrucciones:** Esta sección contiene agendas y consejos prácticos para facilitar las ceremonias o "rituales" más importantes del marco. El rol del facilitador es crucial para asegurar que estas reuniones sean productivas, enfocadas y logren su propósito.

#### **Guía A.5.1: Taller de Mapeo de Capacidades (Σ-E)**

* **Objetivo:** Crear la v1.0 del `Mapa de Capacidades` de la organización.
* **Duración:** 3-4 horas.
* **Participantes:** Equipo directivo, jefes de división, arquitectos.
* **Agenda y Consejos:**
    1. **Introducción (15 min):** Explique el concepto de "capacidad" vs. "función organizacional". El objetivo es pensar en "qué hacemos", no en "quiénes somos".
    2. **Divergencia - Brainstorming (60 min):** Pida a los participantes que escriban en post-its todas las "habilidades" que tiene la organización. Fomente la cantidad sobre la calidad en esta etapa. Use la pregunta: "¿Qué cosas hace nuestra organización para cumplir su misión?".
    3. **Convergencia - Agrupación (90 min):** Pida al grupo que se levante y agrupe los post-its por afinidad en una pizarra. Guíe la conversación para nombrar estos grupos (las macro-capacidades) y sub-grupos.
    4. **Evaluación (45 min):** Para cada capacidad principal, facilite una votación rápida (ej. con puntos o una escala simple) para evaluar su **Madurez** actual y su **Criticidad** estratégica para el próximo año.
    5. **Cierre (15 min):** Resuma los hallazgos, destacando las brechas estratégicas más evidentes (alta criticidad, baja madurez).

#### **Guía A.5.2: Taller de Canvas de Entidad de Valor (Σ-T)**

* **Objetivo:** Crear o actualizar el `Canvas de EV` para un equipo.
* **Duración:** 2-3 horas.
* **Participantes:** El equipo completo de la EV, stakeholders clave.
* **Agenda y Consejos:**
    1. **Preparación:** Dibuje el canvas en una pizarra grande. Tenga a mano los OKRs anuales.
    2. **Secuencia de Llenado:** Guíe al equipo a través de las 9 secciones en un orden lógico: empiece por el **Propósito (1)** y los **Actores (2)**. Luego el **Flujo (3)**. Después las interfaces: **Capacidades (4)**, **Datos (5)** y **Dependencias (7)**. Finalmente, los cimientos: **Tecnología (6)**, **Gobernanza (8)** y **Métricas (9)**.
    3. **Fomente el Diálogo:** Su rol no es rellenar el canvas, sino hacer preguntas que generen debate: "¿Estamos seguros de que este es el principal dolor de nuestro usuario?", "¿Qué pasa si esta dependencia falla?".
    4. **Validación Cruzada:** Al final, lea el canvas en voz alta y valide las conexiones: "¿Las métricas que definimos realmente miden el propósito que declaramos?".

#### **Guía A.5.3: Ceremonia de Ciclo de Valor y Capacidad (CVC) (Δ-E)**

* **Objetivo:** Tomar una decisión de inversión informada sobre una EV.
* **Duración:** 60 minutos por EV.
* **Participantes:** Equipo de la EV, equipo directivo/gobernanza.
* **Agenda y Consejos:**
    1. **Sea Estricto con el Tiempo:** La agenda es la clave. Asigne tiempos fijos a cada sección y cúmplalos.
    2. **Foco en la Evidencia:** El equipo debe "mostrar, no contar". La conversación debe girar en torno a los datos del `Informe de CVC` y la demo en vivo.
    3. **El Rol de la Gobernanza:** Los líderes no están ahí para juzgar, sino para aprender y decidir. Sus preguntas deben ser para entender, no para interrogar: "¿Qué apoyo necesitan para superar ese impedimento?", "¿Qué nos dice este resultado sobre nuestra estrategia?".
    4. **La Decisión es Obligatoria:** La reunión DEBE terminar con una de las cuatro decisiones explícitas (Continuar/Pivotar, Expandir, Reducir, Cerrar). Una no-decisión es el peor resultado.

#### **Guía A.5.4: Retrospectiva del Flujo (Δ-O)**

* **Objetivo:** Que el equipo mejore su propio proceso de trabajo.
* **Duración:** 60 minutos.
* **Participantes:** El equipo completo de la EV. El ambiente debe ser de alta seguridad psicológica.
* **Agenda y Consejos:**
    1. **Preparar Datos:** Traiga las métricas de flujo de la última iteración (Lead Time, Cycle Time, Throughput).
    2. **Estructura Clásica:** Use una estructura simple como "Qué funcionó bien / Qué podríamos mejorar / Qué experimento probaremos".
    3. **Foco en el Sistema, no en las Personas:** La conversación no es sobre culpas individuales, sino sobre cómo mejorar el sistema de trabajo. Use frases como "¿Qué podemos hacer para que sea más fácil entregar valor?" en lugar de "¿Por qué te demoraste en esta tarea?".
    4. **Salga con Acciones Concretas:** La retrospectiva debe generar al menos una acción experimental y medible para la siguiente iteración. Ejemplo: "Vamos a intentar reducir nuestro límite de WIP en la columna 'En Desarrollo' de 3 a 2 para ver si mejora nuestro Lead Time".

### A.6. Guía de Heurísticas y Anti-Patrones Comunes

**Instrucciones:** Esta sección es una referencia rápida para la toma de decisiones. Úsela como una "lista de verificación mental" al diseñar, planificar o ejecutar.

#### **Guía A.6.1: Heurísticas para OKRs**

* **Heurística: "Valor sobre Tareas".** Un buen KR mide un cambio en el comportamiento o resultado del usuario (*outcome*), no la finalización de una tarea (*output*).
  * **Anti-Patrón:** KR = "Lanzar la nueva versión del portal".
  * **Buen Patrón:** KR = "Aumentar la tasa de completitud de tareas en el portal del 50% al 80%".
* **Heurística: "Menos es Más".** Un equipo no debería tener más de 1-2 Objetivos y 2-4 KRs por trimestre. El foco es la clave.
  * **Anti-Patrón:** Un equipo con 5 Objetivos y 15 KRs para un trimestre. Esto es una lista de tareas, no una estrategia.
* **Heurística: "Si no tiene número, no es un KR".** Los Resultados Clave deben ser medibles y verificables sin ambigüedad.
  * **Anti-Patrón:** KR = "Mejorar la satisfacción del usuario".
  * **Buen Patrón:** KR = "Aumentar la puntuación de CSAT de 3.5 a 4.5".

#### **Guía A.6.2: Heurísticas para Historias de Usuario**

* **Heurística: "Pequeñas y con Beneficio".** Una historia debe ser lo suficientemente pequeña para ser completada en pocos días y siempre debe articular el beneficio para el usuario ("...para que...").
  * **Anti-Patrón:** Una historia gigante como "Implementar sistema de pagos".
  * **Buen Patrón:** "Como comprador, quiero pagar con tarjeta de crédito para poder completar mi compra rápidamente".
* **Heurística: "Conversación, no Contrato".** Una historia es una "promesa de una conversación". No debe contener todos los detalles. Los detalles emergen del diálogo entre el Dueño de Producto y el equipo.
  * **Anti-Patrón:** Una historia de usuario de 5 páginas con especificaciones detalladas de la base de datos.

#### **Guía A.6.3: Heurísticas para el Flujo (Xanpan)**

* **Heurística: "Deja de Empezar, Empieza a Terminar".** La prioridad del equipo no es que todos estén ocupados, sino mover las tareas a la columna "Hecho" lo más rápido posible.
  * **Anti-Patrón:** Un tablero con muchos ítems "En Progreso" y pocos ítems moviéndose a "Hecho".
  * **Buen Patrón:** Cuando un miembro del equipo termina su tarea, su primera pregunta es "¿Cómo puedo ayudar a mover otra tarjeta a la derecha?" en lugar de "¿Qué nueva tarea puedo empezar?".
* **Heurística: "El Dolor debe ser Visible".** Los límites de WIP y el tablero visual no resuelven los problemas, los hacen dolorosamente visibles. Si una columna está siempre atascada, el equipo debe detenerse y resolver ese cuello de botella sistémico.
  * **Anti-Patrón:** Ignorar un cuello de botella crónico (ej. "QA siempre está sobrecargado") y seguir empujando trabajo al sistema.

#### **Guía A.6.4: Heurísticas para Arquitectura y Deuda Técnica**

* **Heurística: "La Mejor Arquitectura es la que Menos se Necesita".** Prefiera siempre la solución más simple que resuelva el problema. No introduzca complejidad (ej. un nuevo patrón, una nueva tecnología) a menos que sea absolutamente necesario y esté justificado por un `ADR`.
* **Heurística: "Paga tu Deuda o te Cobrará Intereses".** La deuda técnica no es opcional. Asigne un porcentaje fijo de la capacidad de cada ciclo a pagarla (ej. 20%).
  * **Anti-Patrón:** Tratar el refactoring como una tarea de baja prioridad que siempre se pospone.
  * **Buen Patrón:** El Dueño de Producto y el equipo entienden que pagar la deuda es una inversión en la velocidad futura.
* **Heurística: "API-First".** Al diseñar la integración entre sistemas, la opción por defecto siempre debe ser una API bien definida. Use RPA solo como un último recurso táctico para sistemas legacy que no se pueden cambiar, y siempre con un plan para reemplazarlo por una API a futuro.
